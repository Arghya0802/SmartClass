...
function getAllAdmin() {
  ...
  fetch("forms/adminforms/showadmins.html")
    .then((response) => {
...
function getAllStudents(departmentId) {
  ...
  fetch("forms/adminforms/showstudents.html")
    .then((response) => {
      return response.text();
    })
    .then((data) => {
    ...
    .then((data) => {
      if (data.success) {
        data.registered.forEach((student) => {
          html += "<tr>";
          html +=
            "<td>" + (student.name ? student.name : "Not Registered") + "</td>";
          html += "<td>" + student.uniqueId + "</td>";
          html +=
            "<td><button onclick=\"removeStudent('" +
            student._id +
            "')\"> Remove </button></td>";
          html += "</tr>";
        });
...
function getAllTeachers(departmentId) {
  ...
  fetch("forms/adminforms/showteachers.html")
    .then((response) => {
      return response.text();
    })
    .then((data) => {
    ...
    .then((data) => {
      if (data.success) {
        data.registered.forEach((teacher) => {
          ...
          html +=
            "<td><button onclick=\"removeTeacher('" +
            teacher._id +
            "')\"> Remove </button></td>";
          html += "</tr>";
        });
...
function getAllDepartments() {
  ...
  fetch("forms/adminforms/showdepartments.html")
    .then((response) => {
      return response.text();
    })
    .then((data) => {
    ...
    .then((data) => {
      if (data.success) {
        data.departments.forEach((department) => {
          ...
          html +=
            "<td>" +
            (department.hod ? department.hod : "Not Assigned") +
            "</td>";

          html +=
            "<td><button onclick=\"getAllStudents('" +
            department.uniqueId +
            "')\"> Students List </button></td>";
          html +=
